...
1. Make an [Issue](https://github.com/ligofff/lgf-recents-window/issues/new)
...
```json
    {
        "dependencies": {
            "com.ligofff.lgf-recents-window": "https://github.com/YOUR_USER/lgf-recents-window.git"
        }
    }
```
